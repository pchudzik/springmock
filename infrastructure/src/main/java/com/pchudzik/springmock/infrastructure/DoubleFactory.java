...
public interface DoubleFactory {
	 ...
	 *
	 * <p>This method will be used as mock factory. Each parsed {@link MockDefinition}
	 ...
	 */
	Object createMock(MockDefinition mockDefinition);
	 ...
	 * @return spy of bean
	 */
	Object createSpy(Object bean, SpyDefinition spyDefinition);
}
