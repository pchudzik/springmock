...
@BootstrapWith(ShouldInjectDoubleByAlias.TestContextBootstrapper.class)
public class ShouldInjectDoubleByAlias {
	...
	@AutowiredMock(name = "mocked bean", alias = MOCK)
	@Qualifier(MOCK)
	Service injectedMock;

	@AutowiredSpy(name = "spied bean", alias = SPY)
	@Qualifier(SPY)
	Service injectedSpy;
